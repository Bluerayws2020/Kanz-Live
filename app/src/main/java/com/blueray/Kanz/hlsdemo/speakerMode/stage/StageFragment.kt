package com.blueray.Kanz.hlsdemo.speakerMode.stage
...
import com.blueray.Kanz.hlsdemo.common.reactions.DirectionGenerator
import com.blueray.Kanz.hlsdemo.common.reactions.ZeroGravityAnimation
...
class StageFragment() : Fragment() {
    ...
    override fun onAttach(context: Context) {
        ...
        if (context is Activity) {
            mActivity = context
            meeting = (mActivity as MainActivitys?)!!.getMeeting()
            facingMode = (mActivity as MainActivitys?)!!.getFacingMode()
        }
    }
    ...
    private fun setActionListeners() {
        ...
        btnLeave!!.setOnClickListener { v: View? -> (mActivity as MainActivitys?)!!.showLeaveDialog() }
