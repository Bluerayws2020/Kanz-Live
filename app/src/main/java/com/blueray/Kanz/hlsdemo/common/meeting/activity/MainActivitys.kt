package  com.blueray.Kanz.hlsdemo.common.meeting.activity
...
class MainActivitys : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        meeting = VideoSDK.initMeeting(
            this@MainActivitys, meetingId, localParticipantName,
    ...
    fun showLeaveDialog() {
        val alertDialog =
            MaterialAlertDialogBuilder(this@MainActivitys, R.style.AlertDialogCustom).create()
        ...
        positiveButton.setOnClickListener {
            meeting!!.leave()
            alertDialog.dismiss()
            val intents = Intent(this@MainActivitys, HomeActivity::class.java)
            intents.addFlags(
